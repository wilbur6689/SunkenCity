...
**Tab/I** inventory · **1–0** hotbar · **Ctrl+wheel** zoom · **LMB** interact with objects (click = open/use, hold = pick up) or use the
held item (place / hit / consume) · **RMB** scrap furniture, back walls · **Q** drop ·
**Esc** close menu / quit.
