...
- [x] **CT-01.** How big is the city — number of buildings, world width, and depth to ground in blocks?
  ...
  - *Amended 2026-09-04 (districts, [DistrictsOverhaul.md](DistrictsOverhaul.md)):* **52 towers**, all crowns within 10 cells, jumpable 5–10-cell gaps everywhere (2026-09-05; 2–6 at first), every tower to the ground; world **7,600 × 800 cells** of city plus a pocket annex sized to the tower count. The bell curve and the tapering edges are gone.
- [x] **CT-02.** What building types exist (residential, office, hospital, police, mall, industrial)?
  ...
  - *Amended 2026-09-04 (districts): **mixed-use is removed** — a tower's DISTRICT sets its zone for every floor, its floor height (Res/Bus 12 · Com/Civ 14 · Ind 20 · Con 12 cells) and room width; **construction** joins as the sixth type (unfinished metal + wood frames, near-certain breaches below the waterline, no sealed rooms; keeps the dry cap and hatch). Districts are clusters of 5–6 towers with a 1-tower residential buffer; the 6-tower centre is residential; triple-wide towers only in industrial/commercial. No authored hospital at the start any more.*
- [x] **CT-03.** Do building types drive their loot tables and enemy types?
  ...
  - *Amended 2026-09-04 (districts): the type is the TOWER's district. Depth bands resolve at the **floor** level for enemies, loot and the HUD label — a floor straddling a boundary takes the shallower band (its ceiling row) — while the cold/crush damage gates stay per cell.*
